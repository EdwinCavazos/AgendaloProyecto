...
function Validate(){
    ...
    if(usernameVal === ""){
        ...
        setErrorMsg(username, 'min 6 caracteres');
    }
    else{
    ...
    else if(lastnameVal.length <6){
        setErrorMsg(lastname, 'min 6 caracteres');
    }
    else{
...
// Código que permite visualizar contraseña
